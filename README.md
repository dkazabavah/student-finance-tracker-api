...
```nginx
upstream student\_tracker\_backend {
    server WEB01\_IP:80;
    server WEB02\_IP:80;
}
...
server {
    ...
    location / {
        proxy\_pass http://student\_tracker\_backend;
...
* Link to my web application: https://davidkb.tech
